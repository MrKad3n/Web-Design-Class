...
function getTypeInfo(type) {
    const typeData = {
        ...
        'Army': { color: '#3498db', icon: '⚔️' },
        'Rogue': { color: '#2c3e50', icon: '🗡️' },
        'Mage Guild': { color: '#9b59b6', icon: '🔮' },
        'Mercenary': { color: '#95a5a6', icon: '💰' },
        'Cultist': { color: '#8e44ad', icon: '🕯️' },
        'Paladin': { color: '#f1c40f', icon: '🛡️' },
        'Assassin': { color: '#34495e', icon: '🔪' },
        'Royal Guard': { color: '#f39c12', icon: '👑' },
